...
logo após a tomada da cidade. Um comboio logístico foi enviado e foi possível a construção da base no aeroporto.
<br/>
<br/>
...
<br/>
<br/>
É certo que ainda hajam pessoas que são contra a invasão dos EUA na região, tanto dentro de Rasman quanto nas cidades vizinhas, pois então, é necessário estabelecer
relações amigáveis com a população civil local. O Alto Comando acredita que se a missão for um sucesso a inimizade dos civis diminuirá.
<br/>
<br/>
Observação:
<br/>
Por mais que o exército iraquiano foi expulso para o Sul de Takistan, ainda restam várias facções armadas pela região que também foram afetadas pela 
falta de fornecimento de água e que muito provavelmente compartilham da mesma aversão dos civis quanto à presença norte-americana em Takistan. Por isso, tomem as precauções 
necessárias para o prosseguimento da missão.
"]];
