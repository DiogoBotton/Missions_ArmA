...
if (ambientCivilians == 1) then {
	...
	10 - is the area to scan for hostiles that can instill fear in the triggerman (read above for how fear works).
	30 - is the area to scan for possible victims that will make the triggerman touch the bomb off.
	75 - is the % for the triggerman to be a suicide bomber instead
	WEST - is the side to consider enemy of the triggerman */
	nul0 = [200,1,70,10,"house",0,100,10,30,75,WEST] execVM "common\server\IEDdetect\IEDdetect_ambientBombers.sqf";
};
