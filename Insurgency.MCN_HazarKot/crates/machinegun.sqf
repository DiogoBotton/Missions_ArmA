...
/////////////////////////////////////////////////////
	...
	_this addWeaponCargo ["BAF_L110A1_Aim", 30];
	_this addWeaponCargo ["M249_TWS_EP1", 30];
	_this addWeaponCargo ["M249_m145_EP1", 30];
	_this addWeaponCargo ["ACE_M249_AIM", 30];
	_this addWeaponCargo ["ACE_M249Para", 30];
	_this addWeaponCargo ["ACE_M249_PIP_ACOG", 30];
	_this addWeaponCargo ["m8_SAW", 30];
	...
	_this addWeaponCargo ["Mk_48", 30];
	_this addWeaponCargo ["Mk_48_DES_EP1", 30];
	_this addWeaponCargo ["BAF_L7A2_GPMG", 30];
	_this addWeaponCargo ["ACE_BAF_L7A2_GPMG", 30];
	_this addWeaponCargo ["m240_scoped_EP1", 30];
	_this addWeaponCargo ["M60A4_EP1", 30];
	_this addWeaponCargo ["ACE_M240L_M145", 30];
