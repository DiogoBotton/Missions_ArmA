...
setDate [2008, 5, 11, horaInicio, 0];

caveirao addAction ["Caveira", "caveiraMsc.sqf"];

["A Favela, Sangin", "11 de Maio de 2008", "Base do B.O.P.E"] spawn BIS_fnc_infoText;